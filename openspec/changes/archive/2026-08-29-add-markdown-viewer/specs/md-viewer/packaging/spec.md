...
The executable SHALL include every frontend asset and data file the viewer needs at runtime, so no
asset is loaded from a path relative to the source tree.
